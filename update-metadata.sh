...
subxt metadata --url wss://westend.rpc.turboflakes.io:443 --pallets Session -f bytes > metadata/westend_metadata_small.scale
# subxt metadata --url wss://paseo.rpc.turboflakes.io:443 -f bytes > metadata/paseo_metadata.scale
subxt metadata --url wss://paseo.rpc.turboflakes.io:443 --pallets Session -f bytes > metadata/paseo_metadata_small.scale
...
# AssetHub Chains
subxt metadata --url wss://asset-hub-westend.rpc.turboflakes.io:443 --pallets System,Balances,Staking,Utility,NominationPools -f bytes > metadata/asset_hub_westend_metadata_small.scale
subxt metadata --url wss://asset-hub-paseo.rpc.turboflakes.io:443 --pallets System,Balances,Staking,Utility,NominationPools -f bytes > metadata/asset_hub_paseo_metadata_small.scale
