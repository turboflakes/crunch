...
#[subxt::subxt(
    runtime_metadata_path = "metadata/creditcoin_metadata.scale",
...
type Call = node_runtime::runtime_types::creditcoin3_runtime::RuntimeCall;
    ...
    if let Some(members) = try_fetch_pool_members_for_compound(&crunch).await? {
        ...
        for member in &members {
            ...
            let call = Call::NominationPools(NominationPoolsCall::bond_extra_other {
                member: subxt::utils::MultiAddress::Id(member.clone()),
